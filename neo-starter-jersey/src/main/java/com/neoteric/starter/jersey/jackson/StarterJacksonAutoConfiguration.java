...
public class StarterJacksonAutoConfiguration {
    ...
    static class ZonedDateTimeJacksonConfiguration {
        ...
        @Bean(name = StarterConstants.ConfigBeans.JACKSON_JSR310_DATE_FORMAT)
        @ConditionalOnMissingBean(name = StarterConstants.ConfigBeans.JACKSON_JSR310_DATE_FORMAT)
        ...
        public Module zonedDateTimeSerializationModule(
                @Qualifier(StarterConstants.ConfigBeans.JACKSON_JSR310_DATE_FORMAT) DateTimeFormatter dateTimeFormatter) {
