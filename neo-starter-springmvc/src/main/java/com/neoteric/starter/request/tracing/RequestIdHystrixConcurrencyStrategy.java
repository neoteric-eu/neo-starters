...
public class RequestIdHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
    ...
    private void logCurrentStateOfHystrixPlugins(HystrixEventNotifier eventNotifier,
        ...
        LOG.debug("{}Current Hystrix plugins configuration [concurrencyStrategy [{}], eventNotifier [{}], metricPublisher [{}], " +
                "propertiesStrategy [{}]]", StarterConstants.LOG_PREFIX, this, eventNotifier, metricsPublisher, propertiesStrategy);
        LOG.debug("{}Registering MDC Hystrix Concurrency Strategy.", StarterConstants.LOG_PREFIX);
    }
