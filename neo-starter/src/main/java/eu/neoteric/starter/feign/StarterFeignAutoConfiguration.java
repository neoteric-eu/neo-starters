package eu.neoteric.starter.feign;

import eu.neoteric.starter.feign.tracing.RequestIdAppendInterceptor;
import feign.Feign;
import feign.Logger;
...
import static eu.neoteric.starter.StarterConstants.LOG_PREFIX;
